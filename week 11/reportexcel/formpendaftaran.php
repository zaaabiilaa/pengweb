...
<body>
    ...
    echo "Tanggal isi = ". $tanngalisiformulir; echo "<br>";
    echo "Jenis Pendafataran = ". $jenisPendaftaran; echo "<br>";
    echo "Tanggal Masuk". $tanggalmasuk; echo "<br>";
    echo "NIS = ". $nis; echo "<br>";
    echo "No Pu = ". $nopu; echo "<br>";
    echo "Pernah Paud = ". $pernahpaud; echo "<br>";
    echo "Pernah Paud = ".$pernahtk; echo "<br>";
    echo "SKHUN = ". $skhun; echo "<br>";
    echo "Ijazah = ". $ijazah; echo "<br>";
    echo "Cita-cita = ". $cita; echo "<br>";
    echo "Hobi = ". $hobi; echo "<br>";
    echo "Nama = ".$nama; echo "<br>";
    echo "Jenis Kelamin = ".$jeniskelamin; echo "<br>";
    echo "NISN = ".$nisn; echo "<br>";
    echo "NIK = ".$nik; echo "<br>";
    echo "Tempat Lahir = ".$tempatlahir; echo "<br>";
    echo "Tanggal Lahir = ".$tanggallahir; echo "<br>";
    echo "Agama = ".$agama; echo "<br>";
    echo "Berkebutuhan Khusus = ".$berkebutuhankhususpribadi; echo "<br>";
    echo "Alamat = ".$alamat; echo "<br>";
    echo "RT = ".$rt; echo "<br>";
    echo "RW = ".$rw; echo "<br>";
    echo "Dusun = ".$dusun; echo "<br>";
    echo "Desa = ".$desa; echo "<br>";
    echo "Kecamatan = ".$kecamatan; echo "<br>";
    echo "Pos = ".$pos; echo "<br>";
    echo "Tempat Tinggal = ".$tempattingal; echo "<br>";
    echo "Transportasi = ".$transportasi; echo "<br>";
    echo "No Hp = ".$nohp; echo "<br>";
    echo "No Telp = ".$notlp; echo "<br>";
    echo "Mail = ".$mail; echo "<br>";
    echo "Penerima PKH = ".$penerimapkh; echo "<br>";
    echo "Nomor PKH =  ".$nomorpkh; echo "<br>";
    echo "Kewarganegaraan = ".$kewarganegaraan; echo "<br>";
    echo "Nama Negara = ".$namanegara; echo "<br>";
    echo "Nama Ayah = ".$namaayah; echo "<br>";
    echo "Tahun Ayah = ".$tahunayah; echo "<br>";
    echo "Pendidikan Ayah = ".$pendidikanayah; echo "<br>";
    echo "Pekerjaan Ayah = ".$pekerjaanayah; echo "<br>";
    echo "Penghasilan Ayah = ".$penghasilanayah; echo "<br>";
    echo "Kebutuhan Khusus Ayah =  ".$kebutuhankhususayah; echo "<br>";
    echo "Nama Ibu = ". $namaibu; echo "<br>";
    echo "Tahun Ibu = ". $tahunibu; echo "<br>";
    echo "Pendidikan Ibu = ". $pendidikanibu; echo "<br>";
    echo "Pekerjaan Ibu = ". $pekerjaanibu; echo "<br>";
    echo "Penghasilan Ibu = ". $penghasilanibu; echo "<br>";
